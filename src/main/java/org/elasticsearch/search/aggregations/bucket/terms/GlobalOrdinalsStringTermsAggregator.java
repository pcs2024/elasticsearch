...
import org.elasticsearch.search.aggregations.support.bytes.BytesValuesSource.WithOrdinals;
...
public class GlobalOrdinalsStringTermsAggregator extends AbstractStringTermsAggregator {
    ...
    public GlobalOrdinalsStringTermsAggregator(String name, AggregatorFactories factories, BytesValuesSource.WithOrdinals valuesSource, long estimatedBucketCount,
    ...
    public static class WithHash extends GlobalOrdinalsStringTermsAggregator {
        ...
        public WithHash(String name, AggregatorFactories factories, WithOrdinals valuesSource, long estimatedBucketCount,
